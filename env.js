...
const SYSTEM_ENV = {
  ...
  GAS_WEB_APP_URL: "https://script.google.com/macros/s/AKfycbw8v_f2uaIlLnhr8jZQE5X91gxvrla0urOOA-nUcR46BrKlBaJ19lB_-1U-uMqotNsD/exec",

  // 2. 各公司專屬的 LINE LIFF 設定 (用於前端身分綁定或員工打卡端跳轉)
  LIFF_ID: "2010383109-EolilvJ0",                      // 填入該公司的 LIFF ID
  LIFF_URL: "https://liff.line.me/2010383109-EolilvJ0",  // 填入該公司的 LIFF 專屬網址

  // 3. 當前測試或預設登入的 LINE UID (正式對接 LIFF 後會改由 LINE 登入自動動態取得)
  CURRENT_LINE_UID: "2010383109-EolilvJ0",

  // 4. 企業客製化設定 (方便未來擴充給不同公司)
  COMPANY_NAME: "迦南科技管理部",
